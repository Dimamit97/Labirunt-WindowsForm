...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(62, 41);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label4->Location = System::Drawing::Point(8, 41);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Tahoma", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label5->Location = System::Drawing::Point(11, 72);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(45, 19);
			this->label5->TabIndex = 4;
			this->label5->Text = L"„ас:";
			// 
			// MyForm2
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(274, 111);
...
#pragma endregion
	...
	private: System::Void MyForm2_Load(System::Object^  sender, System::EventArgs^  e) {
		System::IO::StreamReader^ sw = gcnew System::IO::StreamReader("Record.dibil");
		if(String^ s = sw->ReadLine())
			this->label2->Text = s+" сек.";
		System::IO::StreamReader^ sw2 = gcnew System::IO::StreamReader("Name.dibil");
		if (String^ s = sw2->ReadLine())
			this->label3->Text = s + ".";
		sw2->Close();
	}
	};
